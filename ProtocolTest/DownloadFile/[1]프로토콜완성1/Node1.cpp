...
int main()
{
	...
	{		
		try
		{
			...
			cout << "Check userinfo, where is data" << endl;
			cout << "dwunload data" << endl;
			cout << "culcul hash" << endl;
			...
			thread thread([=]
			{
				...
				HttpClient client1("localhost:2222");
				cout << "requst hash 2222" << endl;
				auto req1 = client1.request("POST", "/RequestHash", j1.dump());
				cout << req1->content.string() << endl;

				check--;

				HttpClient client3("localhost:3333");
				cout << "requst hash 3333" << endl;
				auto req3 = client3.request("POST", "/RequestHash", j1.dump());
				cout << req3->content.string() << endl;
				check--;
